...
import { generateGradientStops, hexToRgb } from '@/lib/generator/color';
        ...
        <>
          <div
            ...
            style={{
              ...
              left: -glowSize / 2,
              borderRadius: '50%',
              backgroundImage: `radial-gradient(circle, rgba(${glowRgb.r}, ${glowRgb.g}, ${glowRgb.b}, ${glowOpacity}) 0%, transparent 70%)`,
          ...
          <div
            ...
            style={{
              ...
              right: -glowSize / 2,
              borderRadius: '50%',
              backgroundImage: `radial-gradient(circle, rgba(${glowRgb2?.r ?? glowRgb.r}, ${glowRgb2?.g ?? glowRgb.g}, ${glowRgb2?.b ?? glowRgb.b}, ${glowOpacity * 0.75}) 0%, transparent 70%)`,
